\ 
\ Last change: KS 03.08.2022 10:29:31
\
...
Create Errors    0 ,
Create Ambiguous 0 ,
Create Ptr       Arguments , \ After initial boot Ptr must be initialized to: '$28 Ptr !'
initialized
...
: boot  ( -- )   0 Dividend erase   CALL initialization   debug-service ;
